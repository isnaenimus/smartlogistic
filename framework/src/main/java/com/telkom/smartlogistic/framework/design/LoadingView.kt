package com.telkom.smartlogistic.framework.design
...
import com.telkom.framework.R
import com.telkom.smartlogistic.framework.extention.showToast
...
class LoadingView(context: Context, attrs: AttributeSet?, defStyleAttr: Int) :
    ...
    private fun showLoading() {
        ...
        baseView?.background = ContextCompat.getDrawable(context, R.color.colorWhite)
        showButton()
        showProgress()
    }
